...
pub async fn contribution_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.contribution_types (id, name, applies_to, description,
...
pub async fn dataset_consent_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.dataset_consent_types (id, name, description, 
...
pub async fn dataset_deidentification_levels(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.dataset_deidentification_levels (id, name, description, 
          list_order, source_org, date_added)
       values 
...
pub async fn dataset_recordkey_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.dataset_recordkey_types (id, name, description, 
          list_order, source_org, date_added)
       values 
...
pub async fn date_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn description_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn doi_status_types(pool: &Pool<Postgres>) -> Result<(), AppError> {

    let sql = r#"drop table if exists lups.doi_status_types;
    ...
    let sql = r#"insert into lups.doi_status_types (id, name, description, 
          list_order, source_org, date_added)
       values 
...
pub async fn gender_eligibility_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn iec_level_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn language_usage_types(pool: &Pool<Postgres>) -> Result<(), AppError> {

    let sql = r#"drop table if exists lups.language_usage_types;
    ...
    let sql = r#"insert into lups.language_usage_types (id, name, description, 
          list_order, source_org, date_added)
       values 
...
pub async fn object_access_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn object_classes(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn object_filter_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.object_filter_types (id, filter_as, description, 
          list_order, source_org, date_added)
       values
...
pub async fn object_relationship_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn object_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn org_attribute_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn org_classes(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.org_classes (id, name, description, list_order, source_org, date_added)
       values 
...
pub async fn org_name_qualifier_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.org_name_qualifier_types (id, name, description, 
          list_order, source_org, date_added)
       values 
...
pub async fn org_relationship_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.org_relationship_types (id, name, description, 
          list_order, source_org, date_added)
       values 
...
pub async fn org_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn resource_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn size_units(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.size_units (id, name, list_order, source_org, date_added)
       values 
...
pub async fn study_feature_categories(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn study_feature_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn study_relationship_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn study_statuses(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.study_statuses (id, name, description, 
          use_in_data_entry, list_order, source_org, date_added)
       values
...
pub async fn study_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.study_types (id, name, description, 
          use_in_data_entry, list_order, source_org, date_added)
       values 
...
pub async fn time_units(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.time_units(id, name, use_in_data_entry, list_order, source_org, date_added)
       values
...
pub async fn title_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn topic_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn topic_vocabularies(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn trial_registries(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.trial_registries (id, name, description, 
          list_order, source_org, date_added)
       values 
...
pub async fn language_codes(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn language_scripts(pool: &Pool<Postgres>) -> Result<(), AppError> {
...
pub async fn reset_message_sql(pool: &Pool<Postgres>) -> Result<(), AppError> {
