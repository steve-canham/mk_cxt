...
pub async fn create_study_identifier_types(pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let sql = r#"insert into lups.study_identifier_types (id, old_id, name, description, 
       ...
       values 
        (100,11,'Trial registry ID (registry unspecified)',null,'Use now DEPRECATED. In most cases a trial registry ID’s format and context should allow the specific registry to be identified.',null,null,0,'n/a',false,0),
        (115,0,'WHO universal trial ID','Number provided by WHO as the Universal Trial Number or UTN.  Unfortunately only a relatively small proportion of studies have it.',null,'U1111-1131-4384, U1111-1130-8248, U1111-1132-3386','1111-[0-9]{4}-[0-9]{4}  (Initial U often missing in source data)',100114,'World Health Organisation',true,115),
        (116,0,'Australian New Zealand CTR ID','Number provided by the ANZCTR.',null,'ACTRN12605000057684, ACTRN12622001013752','ACTRN[0-9]{14}',100690,'National Health and Medical Research Council, Australia',true,116),
        ...
        (405,0,'US Department of Defense Grant ID','Funding ID from the US Department of Defense',null,null,null,0,null,true,0), 
        (406,0,'CDC Grant ID','Grant id of award from the US Centers for Disease Control and Prevention',null,null,null,0,null,true,0), 
        (407,0,'NCI Grant ID','Grant id of award from the US National Cancer Institute (part of NIH).',null,null,null,0,null,true,0), 
        ...
        (412,0,'National Science and Technology Council  Taiwan Grant ID',null,null,null,null,0,null,true,0), 
        ...
        (704,0,'Alcon Research study ID','Alcon research identifier - quite varied in form. At one time Alcon was part of Novartis',null,null,null,0,null,true,0), 
        (705,0,'Pfizer ID',null,null,null,null,0,null,true,0), 
        (706,0,'GSK ID',null,null,null,null,0,null,true,0), 
        (707,0,'Roche ID',null,null,null,null,0,null,true,0), 
        (708,0,'Astra Zeneca ID',null,null,null,null,0,null,true,0), 
        (709,0,'Takeda ID',null,null,null,null,0,null,true,0), 
        (710,0,'Johnson and Johnson ID',null,null,null,null,0,null,true,0), 
        (711,0,'Jannsen ID',null,null,null,null,0,null,true,0), 
        (712,0,'Sanofi-Aventis ID',null,null,null,null,0,null,true,0), 
        (713,0,'BMS ID',null,null,null,null,0,null,true,0), 
        (714,0,'AbbVie ID',null,null,null,null,0,null,true,0), 
        (715,0,'Bayer ID',null,null,null,null,0,null,true,0), 
        (800,12,'Ethics review ID (unspecified)','Org id should identify the review body.',null,null,null,0,null,true,350),
        (801,0,'CCMO ID','Dutch Ethics approval ID, as issued by CCMO',null,null,null,0,null,true,0), 
